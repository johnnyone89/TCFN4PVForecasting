...
All feature configurations, model-selection decisions, thresholds, and ensemble settings are fixed using the ***training and validation periods only*** before the held-out test data are evaluated.
...
**Email:** [jmoon25@duksung.ac.kr](mailto:jmoon25@duksung.ac.kr)
